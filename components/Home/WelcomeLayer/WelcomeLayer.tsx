...
export default function WelcomeLayer() {
  return (
    <Card radius="none" className="w-full" isPressable>
      <div className="flex gap-4 w-full text-center md:text-start bg-gradient-to-l from-cyan-500 to-teal-200 flex-col text-black justify-center items-center h-[300px]">
